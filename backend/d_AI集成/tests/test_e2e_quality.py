...
import pytest
from backend.公共.metrics import calc_hallucination_rate, calc_coverage, calc_adaptation_accuracy
...
class TestQualityGate:
    ...
    def test_adaptation_accuracy(self):
        """适配准确率 ≥ 0.85。"""
        profile = {"level": "初级", "style": "视觉型"}
        content = {"difficulty": "初级", "format": "图文"}
        acc = calc_adaptation_accuracy(profile, content)
